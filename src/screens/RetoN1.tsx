...
// Asegúrate de que estos nombres coinciden con tus PNG
...
export const LEVELS_N1_DRAGON: LevelConfig[] = [
  {
    ...
    phases: [{ id: 1, name: 'Fase Única · Desafío Final' }],
  },
];

// Por ahora usamos 2 preguntas por fase (demo)
            ...
            <View style={styles.summaryModalContent}>
              ...
              >
                <Text style={styles.summaryButtonText}>
                  {isPhaseCompleted
                    ? 'Volver a intentar con más preguntas'
                    : 'Reintentar combate'}
                </Text>
              </TouchableOpacity>
