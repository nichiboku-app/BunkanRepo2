...
import { UserPlanProvider } from "./src/context/UserPlanContext"; // ✅ Agregado: UserPlanProvider
...
import ChatOnboarding from './src/screens/ChatOnboarding';
...
import { default as CursoN2Screen, default as N2BrowseScreen } from "./src/screens/N2/N2BrowseScreen";
...
export default function App() {
  ...
  return (
    <UserPlanProvider> {/* ✅ UserPlanProvider agregado */}
      <StripeProvider publishableKey="pk_test_51SW4BY0ah48A1xwkicGIM1gEXwNCHkOVY8rtmoccJBJWGWBTc7TllMeHmZWTKkx04BZuY5sXSTBJUBpYPWTMuuS00CvuO8tlc">
            ...
            <B3ScoreProvider>
              ...
              >
                ...
                >
                  ...
                  {/* === Utilidades y navegación global === */}
                  <Stack.Screen
                    name="ChatOnboarding"
